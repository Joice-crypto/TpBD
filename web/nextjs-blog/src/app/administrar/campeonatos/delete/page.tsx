...
return (
    <>
     <p className='text-center text-xl m-6'>Excluir Campeonatos</p>
        ...
        return (
            ...
            <div  key={camp.ID_camp} className="justify-items-center mt-16 grid grid-cols-2 gap-1 ">
                ...
                <button className="bg-red-400 h-8 rounded-full w-20 m-5 mt-8">
                    <p className="text-center text-black "> <a href={`http://localhost:3000/administrar/campeonatos/apagar/${camp.ID_camp}`} > Excluir </a></p>
                </button>
                </div>
